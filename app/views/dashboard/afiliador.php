...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Today's Appointments (Citas del día) -->
        <div class="bg-white rounded-xl shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">📅 Citas del Día</h3>
            </div>
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                        <div class="flex-shrink-0 w-12 text-center">
                            <span class="text-lg font-bold text-blue-600"><?php echo date('H:i', strtotime($appointment['scheduled_date'])); ?></span>
                        </div>
                        <div class="ml-4 flex-1">
                            <p class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($appointment['title']); ?></p>
                            <p class="text-xs text-gray-500">
                                <?php echo htmlspecialchars($appointment['business_name'] ?? $appointment['owner_name'] ?? '-'); ?>
                            </p>
                        </div>
                        <div class="flex items-center space-x-2">
                            <?php if (!empty($appointment['whatsapp'])): ?>
                            <a href="https://wa.me/52<?php echo preg_replace('/[^0-9]/', '', $appointment['whatsapp']); ?>" 
                               target="_blank" 
                            ...
                            <a href="<?php echo BASE_URL; ?>/afiliados/<?php echo $appointment['contact_id']; ?>/expediente" 
